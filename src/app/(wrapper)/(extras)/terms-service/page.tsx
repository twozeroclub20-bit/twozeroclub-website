      ...
      <section className="max-w-[1800px] m-auto py-8 px-4 md:px-16 flex flex-col  ">
        ...
        <div className="max-w-[1000px] w-full lg:w-[60%]  m-auto ">
          ...
          <p className="mt-2 font-area text-[1rem]">
            ...
            <br />
            <br />
            By using our Site, creating an account, or purchasing from us, you
            confirm that you accept these Terms. If you do not agree, you must
            not use the Site.
            <br />
            <br />
            We may update these Terms from time to time by posting changes on
          ...
          <ul className="list-disc ml-6 font-area text-[1rem]">
            ...
            <li>Our Returns & Refunds Policy.</li>
            <li>
              Any specific terms for promotions, events, or other services we
              provide.
            </li>
          </ul>
          ...
          <ul className="list-disc ml-6 mt-2 font-area text-[1rem]">
            ...
            <li>
              ...
              including in cases of suspected fraud, errors in pricing, or
              product unavailability.
            </li>
            <li>
              All prices are subject to change without notice. Taxes, shipping
              fees, and duties may apply depending on your location.
            </li>
          </ul>
          ...
          <ul className="list-disc ml-6 mt-2 font-area text-[1rem]">
            ...
            <li>
              Local taxes and import duties may apply and are the {`customer’s`}
              responsibility.
            </li>
            <li>
              We are not liable for delays caused by customs, courier errors, or
              events outside our control.
            </li>
            <li>
              Risk of loss passes to you once the order is delivered to the
              carrier
            </li>
          </ul>
          ...
          <ul className="list-disc ml-6 mt-2 font-area text-[1rem]">
            ...
            <li>
              Return shipping costs are your responsibility. If returned items
              arrive damaged, only partial refunds may be issued
            </li>
            <li>
              Damaged or defective items must be reported within 7 days of
              delivery with supporting photos. Replacements will be offered
              where possible.
            </li>
          </ul>
          ...
          <ul className="list-disc ml-6 mt-2 font-area text-[1rem]">
            ...
            <li>
              You may not copy, reproduce, distribute, or use any part of our
              Site or products for commercial purposes without prior written
              cosent.
            </li>
          </ul>
          ...
          <ul className="list-disc ml-6 mt-4 font-area text-[1rem]">
            ...
            <li>
              Nothing in these Terms excludes liability for fraud, death, or
